[![Run App NateMatthews](https://github.com/nmatthews5/GithubAction/actions/workflows/run-app.yaml/badge.svg)](https://github.com/nmatthews5/GithubAction/actions/workflows/run-app.yaml)
